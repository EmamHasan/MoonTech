...
$sql = "select products.Product_ID, Selling_Price, Purchased_Price, product_image, Model, Resolution, Screen_Size, Response_Time, Refresh_Rate, Input_Type from products, monitor where monitor.Product_ID=products.Product_ID";
...
function component($Model, $Purchased_Price, $productimg, $Resolution, $Screen_Size, $Response_Time, $Refresh_Rate, $Input_Type){
  $element = "
              ...
              <form  method=\"post\">
                  <div class=\"card shadow\" style=\"background-color: black;\">
                      ...
                      <div class=\$productimg\"card-body\">
                          ...
                          <p class=\"card-text\">
                          <h6>Resolution: $Resolution</h6>
                          <h6>Screen Size: $Screen_Size </h6>
                          <h6>Response Time: $Response_Time <h6>
                          <h6>Refresh Rate: $Refresh_Rate <h6>
                          <h6>Input Type: $Input_Type <h6>
...
<div class="pbox">
  ...
  while ($row = $result-> fetch_assoc()){
      component($row['Model'], $row['Purchased_Price'], $row['product_image'], $row['Resolution'], $row['Screen_Size'], $row['Response_Time'], $row['Refresh_Rate'], $row['Input_Type']);
  }
    ?>
