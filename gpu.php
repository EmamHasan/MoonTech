...
$sql = "select products.Product_ID, Selling_Price, Purchased_Price, product_image, Model, Chipset, Memory, Memory_Type, Max_Res from products, gpu where gpu.Product_ID=products.Product_ID";
...
function component($Model, $Purchased_Price, $productimg, $Chipset, $Memory, $Memory_Type, $Max_Res){
  $element = "
...
<div class="pbox">
  ...
  while ($row = $result-> fetch_assoc()){
      component($row['Model'], $row['Purchased_Price'], $row['product_image'], $row['Chipset'], $row['Memory'], $row['Memory_Type'], $row['Max_Res']);
  }
    ?>
