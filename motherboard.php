...
$sql = "select products.Product_ID, Selling_Price, Purchased_Price, product_image, Model, Socket, Size, Supported_RAM from products, motherboard where motherboard.Product_ID=products.Product_ID";
...
function component($Model, $Purchased_Price, $productimg, $Processor_Type, $Size, $Supported_RAM){
  $element = "
              ...
              <form  method=\"post\">
                  <div class=\"card shadow\" style=\"background-color: black;\">
                      ...
                      <div class=\$productimg\"card-body\">
                          ...
                          <p class=\"card-text\">
                          <h6>Processor Type: $Processor_Type</h6>
                          <h6>Size: $Size</h6>
                          <h6>Supported RAM: $Supported_RAM<h6>
...
<div class="pbox">
  ...
  while ($row = $result-> fetch_assoc()){
      component($row['Model'], $row['Purchased_Price'], $row['product_image'], $row['Socket'], $row['Size'], $row['Supported_RAM']);
  }
    ?>
