...
$sql = "select products.Product_ID, Selling_Price, Purchased_Price, product_image, Model, Wattage, Modular, Efficiency from products, power_supply where power_supply.Product_ID=products.Product_ID";


$result = mysqli_query($conn, $sql);     

function component($Model, $Purchased_Price, $productimg, $Wattage, $Modular, $Efficiency){
  $element = "
              ...
              <form  method=\"post\">
                  <div class=\"card shadow\" style=\"background-color: black;\">
                      ...
                      <div class=\$productimg\"card-body\">
                          ...
                          <p class=\"card-text\">
                          <h6>Wattage: $Wattage</h6>
                          <h6>Modular: $Modular</h6>
                          <h6>Efficiency: $Efficiency<h6>
...
<div class="pbox">
  ...
  while ($row = $result-> fetch_assoc()){
      component($row['Model'], $row['Purchased_Price'], $row['product_image'], $row['Wattage'], $row['Modular'], $row['Efficiency']);
  }
    ?>
