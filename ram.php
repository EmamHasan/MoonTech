...
$sql = "select products.Product_ID, Selling_Price, Purchased_Price, product_image, Model, Memory_Type, Capacity, Bus_Speed from products, ram where ram.Product_ID=products.Product_ID";
              ...
              <form  method=\"post\">
                  <div class=\"card shadow\" style=\"background-color: black;\">
                      ...
                      <div class=\$productimg\"card-body\">
                          ...
                          <h6>Capacity: $Capacity GB</h6>
                          <h6>Bus Speed: $Bus_Speed MHz<h6>
...
<div class="pbox">
  ...
  while ($row = $result-> fetch_assoc()){
      component($row['Model'], $row['Purchased_Price'], $row['product_image'], $row['Memory_Type'], $row['Capacity'], $row['Bus_Speed']);
  }
    ?>
